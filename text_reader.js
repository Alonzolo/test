...
var TextReader = {
	...
	playByExternalService: function(lang, text)
	{
		...
		// TODO: move translateProvider to widget-variable
		if ((translateProvider == "sogou")
		...
		//		if ((!lang_default_locales[lang] || (translateProvider == "google"))
		else if (//(translateProvider == "google") &&
					(this.supportMP3 || (this.supportMP3 === null && (this.supportMP3 = (new Audio()).canPlayType("audio/mpeg")) ))
				)
		{
			player = new Audio("https://translate.google."+(widget.useGoogleCn ? "cn" : "com")+"/translate_tts?ie=UTF-8&client=tw-ob"
								+"&tl=" + lang
